...
class ConfigSanitizer:
    ...
    def __init__(
        self, support_dreambooth: bool, support_finetuning: bool, support_dropout: bool
    ) -> None:
        assert (
            support_dreambooth or support_finetuning
        ...
        **runtime_params,
        ...
        for dataset_config in sanitized_user_config.get("datasets", []):
            ...
            dataset_blueprints.append(
                DatasetBlueprint(is_dreambooth, params, subset_blueprints)
            )
